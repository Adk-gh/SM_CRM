...
// Defined with only one branch as requested
const SM_BRANCHES = [
...
const SupportTicketSubmit = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    userEmail: '',
    userPhone: '',
    // Initialize with the single available branch
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const ticketData = {
        ...
        // Helper to get the label from the single-item array
  ...
  const resetForm = () => {
    setFormData({
      ...
      userEmail: '',
      userPhone: '',
      smBranch: 'sm-san-pablo', // Reset to default
      issueCategory: '',
      issueTitle: '',
      issueDescription: '',
      files: []
  ...
  if (uiState.submitted) {
    return (
      <div className="support-ticket-container" data-theme={theme}>
          ...
          <form onSubmit={handleSubmit} className="ticket-form">
            <div className="form-section">
              ...
              <div className="form-grid">
                ...
                {/* Branch Selection Restored - Only shows SM San Pablo */}
                <div className="form-group">

...
// NEW STATE: Control the visibility of the logout confirmation dialog
...
// NEW REF: For the logout confirmation modal (optional, for focus handling)
...
// Close the User Drawer when clicking outside
useEffect(() => {
...
// Add event listener when user drawer is open
if (showUserDrawer) {
...
// NEW FUNCTION: Show the confirmation dialog
const handleLogoutClick = () => {
setShowProfileMenu(false); // Close profile menu first
setShowLogoutConfirmation(true); // Open the confirmation dialog
};

// UPDATED FUNCTION: Performs the actual sign out
...
setShowLogoutConfirmation(false); // Close the dialog
}
};
...
{/* User Drawer */}
<div 
className={`user-drawer ${showUserDrawer ? 'active' : ''}`}
ref={userDrawerRef}
>
...
<div className="logout-confirmation-modal" ref={logoutConfirmationRef}>
<h3>Confirm Logout</h3>
<p>Are you sure you want to log out of the system?</p>
<div className="modal-actions">
<button className="btn btn-primary btn-logout" onClick={confirmLogout}>
<span>Yes, Logout</span>
</button>
<button className="btn btn-secondary" onClick={() => setShowLogoutConfirmation(false)}>
<span>No, Stay Logged In</span>
</button>
</div>
</div>
</div>
...
{/* UPDATED: Call handler for confirmation dialog */}
<button 
className="profile-menu-item"
